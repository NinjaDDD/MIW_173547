namespace KNN_Okienkowy
{
    public class Form1 : Form
    {
        private const int liczbaSasiadow = 3;
        private TextBox Wyniki;
        private Button Przycisk;

        public Form1()
        {
            Text = "KNN Klasyfikator";
            ...
            Wyniki = new TextBox
            {
                ...
                Size = new System.Drawing.Size(470, 330)
            };
            ...
            Przycisk.Click += FunkcjaPrzycisk;

            Controls.Add(Wyniki);
            Controls.Add(Przycisk);
        }

        private void FunkcjaPrzycisk(object sender, EventArgs e)
        {
            try
            {
                ...
                foreach (string aktualnaMetryka in metryki)
                {
                    ...
                    Wyniki.AppendText($"Metryka: {aktualnaMetryka} | Dokładność: {dokladnosc:F2}%{Environment.NewLine}");
                }
            }
            catch (Exception ex)
            {
        ...
        static double PoliczOdleglosc(double[] a, double[] b, string metryka)
        {
            ...
            {
                MessageBox.Show("Nieznana metryka!");
                return -1;
            }
        }
    }
